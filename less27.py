...
getik(22,33,44,55)      #(22, 33, 44, 55) - кортеж аргументов

def getik2(**kwargs):
    print(kwargs)

getik2(a=1,b=20,c=30)   #{'a': 1, 'b': 20, 'c': 30} -- словарь аргументов

# именованые всегда должны быть указаны после позиционных
